...
const workInfo = [
  {
    ...
    skillsInfo: [
      { name: "TS", icon: "/icons/typescript.svg" ,isShow:false},
      { name: "React", icon: "/icons/react.svg" ,isShow:false},
      { name: "Next.js", icon: "/icons/nextJs.svg" ,isShow:false},
      { name: "MUI", icon: "/icons/materialUI.svg" ,isShow:false},
    ],
  ...
  },
  {
    ...
    skillsInfo: [
      { name: "TS", icon: "/icons/typescript.svg" ,isShow:false},
      { name: "React", icon: "/icons/react.svg" ,isShow:false},
      { name: "Redux", icon: "/icons/redux.svg" ,isShow:false},
      { name: "Tailwind", icon: "/icons/tailwind.svg" ,isShow:false},
    ],
  ...
  },
  {
    ...
    skillsInfo: [
      { name: "HTML5", icon: "/icons/html5.svg" ,isShow:false},
      { name: "CSS3", icon: "/icons/css3.svg" ,isShow:false},
      { name: "JS", icon: "/icons/javascript.svg" ,isShow:false},
      { name: "Bootstrap", icon: "/icons/bootstrap.svg" ,isShow:false},
    ],
